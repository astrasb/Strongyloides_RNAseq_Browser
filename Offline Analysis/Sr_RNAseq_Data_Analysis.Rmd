---
title: Offline Data Analysis of Strongyloides ratti bulk RNAseq data
output:
  html_document:
    df_print: paged
    toc: yes
...
This code loads R data objects that has been preproprocessed by `Sr_RNAseq_Data_Processing.rmd`.  
```{r loadBaseData}
...
load(file = "../Strongyloides_RNAseq_Browser/Data/Sr_vDGEList")
...
p3<-ggplot(pca.res.df) +
  ...
  labs(title="S. ratti: Principal Components Analysis of RNAseq Samples",
...
ggsave("Sr_Multivariate_Plots_PCA.pdf",
       plot = p3,
       device = "pdf",
       height = 4,
       #width = 7,
...
ggsave("Sr_Multivariate_Plots_Small_Multiples.pdf",
       plot = p6,
       device = "pdf",
       height = 4,
       width = 8,
