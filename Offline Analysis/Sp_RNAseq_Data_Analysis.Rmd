...
print(paste('Total number of genes in Hunt *et al* 2018 iL3 vs FLF comparison tab:',nrow(Hunt.dat)))
...
ggplot(plotting.all, aes(x = logFC.x, y = logFC.y)) +
  ...
  labs(title = "S. papillosus: All Overlapping Genes: Str-Browser vs Hunt Data",
       subtitle = "comparison = iL3 vs FLF",
...
diffGenes.heatmap <- heatmap.2(diffGenes.thresh,
                               ...
                               key.title = NA,
                               main = paste0("S. papillosus: DEG Heatmap (by life stage): "),
