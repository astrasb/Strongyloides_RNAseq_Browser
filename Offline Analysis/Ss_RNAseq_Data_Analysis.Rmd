...
This code loads R data objects that has been preproprocessed by `Ss_RNAseq_Data_Processing.rmd`. 
```{r loadBaseData}
...
load(file = "../Strongyloides_RNAseq_Browser/Data/Ss_vDGEList")
...
ggsave("Ss_Multivariate_Plots_PCA.pdf",
       plot = p3,
       device = "pdf",
       height = 4,
       #width = 7,
...
#### PCA Plot: a guess at the identity of PC1
...
#### PCA Plot: a guess at the identity of PC2
Plot of the samples in PCA space. Fill color corresponds to potential identity.  
```{r echo = FALSE}
p5
``` 
...
ggsave("Ss_Multivariate_Plots_Small_Multiples.pdf",
       plot = p6,
       device = "pdf",
       height = 4,
       width = 8,
