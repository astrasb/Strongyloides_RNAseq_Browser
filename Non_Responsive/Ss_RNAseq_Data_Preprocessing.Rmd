...
# Generate and Save Digital Gene Expression List
...
log2.cpm.discarded.df.pivot %>%
  ...
  write.csv(file = "../Outputs/SsRNAseq_discardedGene_counts.csv")
...
write.csv(log2.cpm.filtered.norm, file = "../Outputs/SsRNAseq_log2cpm_filtered_norm.csv")
