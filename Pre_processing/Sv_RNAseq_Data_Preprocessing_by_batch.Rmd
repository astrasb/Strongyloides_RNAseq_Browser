...
save(myDGEList,
     file = "../Outputs/SvRNAseq_Group_FLF_PF_DGEList")
...
load(file = "../Outputs/SvRNAseq_Group_FLF_PF_DGEList")
...
write.csv(log2.cpm.filtered.norm, file = "../Strongyloides_RNAseq_Browser/www/SvRNAseq_group_FLF_PF_log2cpm_filtered_norm.csv")
...
save(v.DEGList.filtered.norm,
     file = "../Strongyloides_RNAseq_Browser/Data/Sv_group_FLF_PF_vDEGList")

```

# Replicate above chunks for Group iL3_extended  
