...
Note: samples included in this databasewere collected in at least two separate experiments (although all are filed under the same study accession number, PRJDB3457). Dividing the experiments based on sequencing instrument produces two batches, both of which contain data from Free-living females, permitting batch correction. Samples from one batch mostly represent technical replicates rather than biological replicates. Thus, the low count filtering is set to 1 CPM in at least 1 sample, letting through a substaintial number of low count genes and influencing the zoom modeling.    

# Code  
## Libraries   
Loading required libaries. Code echoing suppressed  
...
## Gene Annotation 
Import gene annotation information for *S. venezuelensis* genes, including: *C. elegans* homologs/percent homology,  *S. papillosus* homologs/percent homology, *S. stercoralis* homologs/percent homology, UniProtKB number, Interpro terms, GO terms, and general Description information using biomart.  
...
# C. elegans homologs/percent homology,  S. papillosus homologs/percent homology, S. stercoralis homologs/percent homology, UniProtKB number, Interpro terms, GO terms, and general Description information using biomart.
...
p1<-ggplot(myTPM.stats) + 
  ...
  labs(y="Median", x = "Standard deviation",
       ...
       caption="S. venezuelensis RNAseq Dataset: all samples") +
  theme_bw()
p1
...
log2.cpm.discarded.df.pivot %>%
  ...
  write.csv(file = "../Strongyloides_RNAseq_Browser/www/SvRNAseq_discardedGene_counts.csv")
...
save(SvRNAseq.preprocessed.data,
     file = "../Outputs/SvRNAseq_data_preprocessed")
