...
save(v.DEGList.filtered.norm,
     file = "../Strongyloides_RNAseq_Browser/Data/Sv_vDGEList")
...
save(v.DEGList.filtered.norm,
     file = "../Outputs/Sv_group_iL3_extended_vDGEList")
...
save(SvRNAseq.preprocessed.data,
     file = "../Outputs/SvRNAseq_allSamples_data_preprocessed")
...
# This file will be imported into Shiny App
save(v.DEGList.filtered.norm,
     file = "../Outputs/Sv_allSamples_vDGEList")
